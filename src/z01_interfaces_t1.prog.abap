...
DATA: go_airplane TYPE REF TO lcl_airplane,
      ...
      gt_partners TYPE STANDARD TABLE OF REF TO lif_partner WITH EMPTY KEY,
...
* Create some vehicles.
      ...
      DATA gt_all_partners TYPE lif_partner=>tt_info.
      LOOP AT gt_partners ASSIGNING FIELD-SYMBOL(<partner>).
        gt_all_partners = CORRESPONDING #(
            BASE ( gt_all_partners )
